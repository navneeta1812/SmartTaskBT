...
export default class Main extends React.Component {
  ...
  getUserDetails() {
    fbHelper
      .database()
      .ref("employee")
      .child(fbHelper.auth().currentUser.uid)
      .on("value", (snapshot) => {
  ...
  render() {
    if (this.state.file != null && !this.state.isLoading) {
      document.getElementById("propic").src = URL.createObjectURL(
        this.state.file[0]
      );
    }
            ...
            <div className="card">
              ...
              <img
                ...
                src={
                  ...
                  this.state.employee.profile_pic != undefined
                    ? this.state.employee.profile_pic
                    : propic
                }
                alt="profilePic"
                width="200px"
              ...
              <div className=" ">
                ...
                <br />
                <button
                  onClick={this.uploadPhotoToDatabase}
                  className="button_decor"
                >
                  Update Profile
                </button>
              </div>
