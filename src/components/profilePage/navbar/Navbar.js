            ...
            <span className="color">
              <div className="nav_dropdown">
                ...
                <button id="username" className="nav_dropbtn">
                  {this.state.userD != null
                    ? this.state.userD.firstname +
                      " " +
                      this.state.userD.lastname
                    : "Name"}
                </button>
                ...
                <div className="nav_dropdown-content">
                  ...
                  <div className="logdiv">
                    ...
                    <a id="logout" onClick={this.logout}>
                      {this.state.userD != null
                        ? "Logout(" +
                          this.state.userD.firstname[0] +
                          this.state.userD.lastname[0] +
                          ")"
                        : "Logout"}
                    </a>
                  </div>
