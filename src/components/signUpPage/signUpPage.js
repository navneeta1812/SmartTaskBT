      ...
      <div className="form_body">
        <form className="form_set">
          ...
          <div className="form_div_">
            ...
            />
            <label for="firstName" className="form_label">
              First Name
            </label>
            ...
            />
            <label for="lastName" className="form_label_">
              Last Name
            </label>
          </div>
          ...
          <div className="form_div">
            ...
            />
            <label for="emailId" className="form_label">
              Email
            </label>
            <br />
            <br />
          ...
          <div className="form_div">
            ...
            />
            <label for="confirmPassword" className="form_label">
              Confirm Password
            </label>
            <br />
            <br />
          ...
          <div>
            <p>
              ...
              />
              I accept all the Terms of Use and Privicy Policy{" "}
            </p>
            {this.state.name ? (
              <span style={{ color: "red", fontSize: 12, fontWeight: "bold" }}>
          ...
          <button className="button_decor" onClick={this.submitForm}>
            Sign Up
          </button>
          <p>
